# Qwen3.6-27B Q4_K_M + DFlash - 131k context, reasoning ON
# Best for: reasoning with 3090-optimized DFlash (Ardenzard tuning)
param(
...
Write-Host "Launching: Qwen3.6-27B Q4_K_M + DFlash (131k, reasoning)" -ForegroundColor Green
