# 128K ctx, q4_0 KV, b4096/ub512, think OFF, vision OFF, dense, MTP (llama.cpp)
#
...
# Context kept at 128K / q4_0 KV. Measured 128K resident = 23.6 GB (llama.cpp) / 23.0 GB (beellama)
...
Write-Host "Launching: Qwen3.8-27B Q4_K_M + MTP llama.cpp (128k, think OFF, vision OFF)" -ForegroundColor Green
