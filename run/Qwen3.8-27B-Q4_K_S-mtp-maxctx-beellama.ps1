...
# MAX CONTEXT = 256K (the model's native limit, per unsloth card: 262,144, extendable to 1M via YaRN).
# Uses the SMALL Q4_K_S quant (15.0 GB) so 256K fits on the 24 GB 3090/250W:
#   Q4_K_S + turbo KV @ 256K (~7 GB, house turbo4/turbo3_tcq pattern) + ~0.5 overhead ~ 22.5 GB.
#   (q4_0 KV is infeasible at 256K: ~10 GB -> ~28 GB total.)
...
Write-Host "Launching: Qwen3.8-27B Q4_K_S + MTP beellama (256k MAX, think OFF, vision OFF, turbo KV)" -ForegroundColor Green
