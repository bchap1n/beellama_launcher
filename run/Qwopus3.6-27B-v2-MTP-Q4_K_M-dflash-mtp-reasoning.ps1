# Qwopus3.6-27B-v2 Q4_K_M + DFlash on MTP — 131k context, reasoning ON, no mmproj
param(
...
Write-Host "Launching: Qwopus3.6-27B-v2 Q4_K_M + DFlash (131k, reasoning)" -ForegroundColor Green
