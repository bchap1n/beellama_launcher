...
$Model = @{
    ...
    # BottleCapAI ThinkingCap-Qwen3.6-27B (brevity finetune, ~46% fewer thinking tokens, MTP baked in)
    "ThinkingCap-Qwen3.6-27B-Q4_K_M" = "D:\.lmstudio\models\bottlecapai\ThinkingCap-Qwen3.6-27B-Q4_K_M-MTP.gguf"
